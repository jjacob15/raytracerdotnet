...
{
    public class StrippedPatternScene : AbstractScene
    {
        public override void Initialize()
        {
            ...
            right.Material.Pattern = new GradientPattern(new Color(0, 1, 0), new Color(0, 0.2, 0));
            right.Transform = Matrix.Transformation().Translation(-1.8, 2.5, -1.5).Scaling(0.25, .25, .25).RotateY(180).Apply();
