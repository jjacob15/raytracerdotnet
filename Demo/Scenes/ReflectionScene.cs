...
namespace Demo.Scenes
{
    public class ReflectionScene : AbstractScene
    {
        public override void Initialize()
        {
            ...
            right.Material = new Material(new GradientPattern(new Color(0, 0, 1), new Color(1, 0.5, 0.1)) { Transform = Matrix.Transformation().Scaling(0.25, 1, 1).RotateY(180).Apply() }, diffuse: 0.7, specular: 1);
