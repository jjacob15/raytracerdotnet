...
namespace RayTracer
{
    public class ShearingTests
    {
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(1, 0, 0, 0, 0, 0).Apply();
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(0, 1, 0, 0, 0, 0).Apply();
            Tuple p = Tuple.Point(2, 3, 4);
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(0, 0, 1, 0, 0, 0).Apply();
            Tuple p = Tuple.Point(2, 3, 4);
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(0, 0, 0, 1, 0, 0).Apply();
            Tuple p = Tuple.Point(2, 3, 4);
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(0, 0, 0, 0, 1, 0).Apply();
            Tuple p = Tuple.Point(2, 3, 4);
        ...
        {
            Matrix m = Matrix.Transformation().Shearing(0, 0, 0, 0, 0, 1).Apply();
            Tuple p = Tuple.Point(2, 3, 4);
