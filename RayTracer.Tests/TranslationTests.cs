...
namespace RayTracer
{
    public class TranslationTests
    {
        ...
        {
            Matrix tranform = Matrix.Transformation().Translation(5, -3, 2).Apply();
        ...
        {
            Matrix tranform = Matrix.Transformation().Scaling(2, 3, 4).Apply();
        ...
        {
            Matrix tranform = Matrix.Transformation().Scaling(-1, 1, 1).Apply();
