...
namespace RayTracer.Patterns
{
    public class StrippedPatternTests
    {
        ...
        public void LightingWithAPattern()
        {
            ...
            m.Lighting(new Sphere(), light, Tuple.Point(0.9, 0, 0), eyeV, normalV, false).Should().Be(Color.White);
            m.Lighting(new Sphere(), light, Tuple.Point(1.1, 0, 0), eyeV, normalV, false).Should().Be(Color.Black);
        }
